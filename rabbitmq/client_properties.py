...
custom_properties = {
    "product": "MyApp",
    "version": "1.0.0",
    "platform": "Custom Python Application",
    "information": "Custom RabbitMQ Client",
    "connection_name": "MyAppConnection",
    "custome_param": "val"
}

# Connection parameters with custom client properties
connection_params = pika.ConnectionParameters(
    host="localhost",
    client_properties=custom_properties
)
